            ...
            switch (new_src_img.bpp) {
                case IMAGE_BPP_BINARY: {
                    if (src_img->bpp == IMAGE_BPP_BAYER) {
                        ...
                        imlib_jpeg_decompress_image_to_binary(&new_src_img, src_img);
                    }
                    break;
                }
                case IMAGE_BPP_GRAYSCALE: {
                    if (src_img->bpp == IMAGE_BPP_BAYER) {
                        ...
                        imlib_jpeg_decompress_image_to_grayscale(&new_src_img, src_img);
                    }
                    break;
                }
                case IMAGE_BPP_RGB565: {
                    if (src_img->bpp == IMAGE_BPP_BAYER) {
                        ...
                        imlib_jpeg_decompress_image_to_rgb565(&new_src_img, src_img);
                    }
                    break;
                }
                case IMAGE_BPP_BAYER: {

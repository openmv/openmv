...
static inline uint32_t vpredicate_8_maybe_min_elements() {
    return (VECTOR_SIZE_BYTES > 4) ? 1 : 4;
}
...
static inline uint32_t vpredicate_16_maybe_min_elements() {
    return (VECTOR_SIZE_BYTES > 4) ? 1 : 2;
}
...
static inline v128_t vmov_u16_narrow_u8_combine(v128_t v0, v128_t v1, bool mask) {
    return (v128_t) {
        .u32 = { (mask ? (v0.u32[0] & 0x00FF00FF) : v0.u32[0]) | ((mask ? (v1.u32[0] & 0x00FF00FF) : v1.u32[0]) << 8) }
    };
}
#endif
...
static inline v128_t vmax_s8(v128_t v0, v128_t v1) {
    #if (__ARM_ARCH >= 8)

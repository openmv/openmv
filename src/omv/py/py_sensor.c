...
STATIC const mp_map_elem_t globals_dict_table[] = {
    ...
    // C/SIF Resolutions
    { MP_OBJ_NEW_QSTR(MP_QSTR_QQQQCIF),             MP_OBJ_NEW_SMALL_INT(FRAMESIZE_QQQQCIF)},  /* 22x18     */
    { MP_OBJ_NEW_QSTR(MP_QSTR_QQQCIF),              MP_OBJ_NEW_SMALL_INT(FRAMESIZE_QQQCIF)},   /* 44x36     */
    ...
    { MP_OBJ_NEW_QSTR(MP_QSTR_QQQQSIF),             MP_OBJ_NEW_SMALL_INT(FRAMESIZE_QQQQSIF)},  /* 22x15     */
    { MP_OBJ_NEW_QSTR(MP_QSTR_QQQSIF),              MP_OBJ_NEW_SMALL_INT(FRAMESIZE_QQQSIF)},   /* 44x30     */

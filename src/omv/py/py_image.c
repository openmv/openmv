...
mp_obj_t py_blob_density(mp_obj_t self_in) {
    ...
    return mp_obj_new_float(IM_MIN(IM_DIV(pixels, ((float) area)), 1));
}
...
static bool py_image_find_blobs_threshold_cb(void *fun_obj, find_blobs_list_lnk_data_t *blob)
{
    ...
    o->corners = mp_obj_new_tuple(4, (mp_obj_t [])
        {mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob->corners[0].x), mp_obj_new_int(blob->corners[0].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob->corners[2].x), mp_obj_new_int(blob->corners[4].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob->corners[4].x), mp_obj_new_int(blob->corners[8].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob->corners[6].x), mp_obj_new_int(blob->corners[12].y)})});
    point_t min_corners[4];
    point_min_area_rectangle(blob->corners, min_corners, 16);
...
static bool py_image_find_blobs_merge_cb(void *fun_obj, find_blobs_list_lnk_data_t *blob0, find_blobs_list_lnk_data_t *blob1)
{
    ...
    o0->corners = mp_obj_new_tuple(4, (mp_obj_t [])
        {mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob0->corners[0].x), mp_obj_new_int(blob0->corners[0].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob0->corners[2].x), mp_obj_new_int(blob0->corners[4].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob0->corners[4].x), mp_obj_new_int(blob0->corners[8].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob0->corners[6].x), mp_obj_new_int(blob0->corners[12].y)})});
    point_t min_area_rect_corners0[4];
    point_min_area_rectangle(blob0->corners, min_area_rect_corners0, 16);
    ...
    o1->corners = mp_obj_new_tuple(4, (mp_obj_t [])
        {mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob1->corners[0].x), mp_obj_new_int(blob1->corners[0].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob1->corners[2].x), mp_obj_new_int(blob1->corners[4].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob1->corners[4].x), mp_obj_new_int(blob1->corners[8].y)}),
         mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(blob1->corners[6].x), mp_obj_new_int(blob1->corners[12].y)})});
    point_t min_area_rect_corners1[4];
    point_min_area_rectangle(blob1->corners, min_area_rect_corners1, 16);
    ...
    for (size_t i = 0; list_size(&out); i++) {
        ...
        o->corners = mp_obj_new_tuple(4, (mp_obj_t [])
            {mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(lnk_data.corners[0].x), mp_obj_new_int(lnk_data.corners[0].y)}),
             mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(lnk_data.corners[2].x), mp_obj_new_int(lnk_data.corners[4].y)}),
             mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(lnk_data.corners[4].x), mp_obj_new_int(lnk_data.corners[8].y)}),
             mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(lnk_data.corners[6].x), mp_obj_new_int(lnk_data.corners[12].y)})});
        point_t min_corners[4];
        point_min_area_rectangle(lnk_data.corners, min_corners, 16);
        o->min_corners = mp_obj_new_tuple(4, (mp_obj_t [])
            {mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(min_corners[0].x), mp_obj_new_int(min_corners[0].y)}),
             mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(min_corners[1].x), mp_obj_new_int(min_corners[1].y)}),
             mp_obj_new_tuple(2, (mp_obj_t []) {mp_obj_new_int(min_corners[2].x), mp_obj_new_int(min_corners[2].y)}),

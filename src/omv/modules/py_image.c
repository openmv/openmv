...
static mp_obj_t py_image_line_op(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args,
    ...
    if (mp_obj_is_integer(args[ARG_image].u_obj)) {
        ...
        int r = IM_MAX(IM_MIN(mp_obj_get_int(rgb888[0]), COLOR_R8_MAX), COLOR_R8_MIN);
        int g = IM_MAX(IM_MIN(mp_obj_get_int(rgb888[1]), COLOR_G8_MAX), COLOR_G8_MIN);
        int b = IM_MAX(IM_MIN(mp_obj_get_int(rgb888[2]), COLOR_B8_MAX), COLOR_B8_MIN);
        switch (image->pixfmt) {
            case PIXFORMAT_BINARY: {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_image_draw_image_obj, 2, py_image_draw_image);
...
STATIC mp_obj_t py_image_binary(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    ...
    static const mp_arg_t allowed_args[] = {
        ...
        { MP_QSTR_invert, MP_ARG_INT | MP_ARG_KW_ONLY, {.u_int = 0} },
        { MP_QSTR_zero, MP_ARG_INT | MP_ARG_KW_ONLY, {.u_int = 0} },
        { MP_QSTR_mask, MP_ARG_OBJ | MP_ARG_KW_ONLY,  {.u_rom_obj = MP_ROM_NONE} },
        { MP_QSTR_to_bitmap, MP_ARG_INT | MP_ARG_KW_ONLY, {.u_int = 0} },
        { MP_QSTR_copy, MP_ARG_INT | MP_ARG_KW_ONLY, {.u_int = 0} },
    };
...
static mp_obj_t py_image_moprh_op(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args, morph_op_t op) {
...
STATIC mp_obj_t py_image_erode(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_moprh_op(n_args, pos_args, kw_args, imlib_erode);
}
...
STATIC mp_obj_t py_image_dilate(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_moprh_op(n_args, pos_args, kw_args, imlib_dilate);
}
...
STATIC mp_obj_t py_image_open(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_moprh_op(n_args, pos_args, kw_args, imlib_open);
}
...
STATIC mp_obj_t py_image_close(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_moprh_op(n_args, pos_args, kw_args, imlib_close);
}
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_image_rsub_obj, 2, py_image_rsub);

STATIC mp_obj_t py_image_mul(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_line_op(n_args, pos_args, kw_args, imlib_mul_line_op);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_image_mul_obj, 2, py_image_mul);

STATIC mp_obj_t py_image_imul(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_line_op(n_args, pos_args, kw_args, imlib_imul_line_op);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_image_imul_obj, 2, py_image_imul);
...
STATIC mp_obj_t py_image_top_hat(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_moprh_op(n_args, pos_args, kw_args, imlib_top_hat);
}
...
STATIC mp_obj_t py_image_black_hat(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    return py_image_moprh_op(n_args, pos_args, kw_args, imlib_black_hat);
}
...
static mp_obj_t py_image_get_similarity(uint n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    ...
    imlib_get_similarity(image, other, args[ARG_x].u_int, args[ARG_y].u_int, x_scale, y_scale, &roi,
                         args[ARG_channel].u_int, args[ARG_alpha].u_int, color_palette, alpha_palette,
                         args[ARG_hint].u_int, &avg, &std, &min, &max);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(py_image_get_similarity_obj, 2, py_image_get_similarity);
...
static const mp_rom_map_elem_t locals_dict_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_imul),                MP_ROM_PTR(&py_image_imul_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_imul),                MP_ROM_PTR(&py_func_unavailable_obj)},

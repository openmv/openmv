...
# SX1261 LoRa Sender
#
# Sends "Hello OpenMV" every second over LoRa using an SX1261 module.
# Uses micropython-lib's lora-sx126x driver (frozen on OPENMV_RT1060).
#
# Use this example for SX1261 modules. For SX1262, use sx1262_sender.py
...
#
# Match radio parameters with the SX1261 receiver example.

...
# contents on a standard EEPROM. To run this example connect an I2C EEPROM
# to your OpenMV Cam (P4 = SCL, P5 = SDA).

from machine import I2C

i2c = I2C(1)  # The user-accessible i2c bus is bus 1 on the OpenMV AE3.

...
# Sets the sensor biases to one of available pre-sets:
#  GENX320_BIASES_DEFAULT       - biases that correspond to GenX320 specification
#  GENX320_BIASES_LOW_LIGHT     - biases tuned for low light conditions
#  GENX320_BIASES_ACTIVE_MARKER - biases tuned for active marker or LED tracking
#  GENX320_BIASES_LOW_NOISE     - low sensitivity low noise biases (default for this driver)
#  GENX320_BIASES_HIGH_SPEED    - biases tuned for high speed motion
csi0.ioctl(csi.IOCTL_GENX320_SET_BIASES, csi.GENX320_BIASES_DEFAULT)
# Disables the AFK filter

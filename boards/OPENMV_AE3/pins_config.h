...
OMV_GPIO_DEFINE(CSI_FSYNC, PORT_13, PIN_0, GPIO, false)

OMV_GPIO_DEFINE(SPI_MISO, PORT_5, PIN_0, SPI0_MISO, true)
OMV_GPIO_DEFINE(SPI_MOSI, PORT_5, PIN_1, SPI0_MOSI, true)
OMV_GPIO_DEFINE(SPI_SCLK, PORT_5, PIN_3, SPI0_SCLK, true)
OMV_GPIO_DEFINE(SPI_SSEL, PORT_5, PIN_2, SPI0_SS0, true)
...
OMV_GPIO_DEFINE(LCD_RST, PORT_7, PIN_3, GPIO, false)
OMV_GPIO_DEFINE(LCD_RS, PORT_1, PIN_2, GPIO, false)
